        ...
        var dataTable = jQuery('#dtable').dataTable({
            ...
            "aoColumns":
                    [
                        ...
                        {"sTitle": "<?= JText::_('COM_APIPORTAL_USER_VIEW_EMAIL_LABEL') ?>", "sWidth": "27%", "bSortable": true,
                            mRender: function ( data, type, full )
                            {
                                return  '<a href="mailto:' + escapeHTML(data.email) + '">' + escapeHTML(data.email) + '</a>';
                            }
                        },
                        {"sTitle": "<?= JText::_('COM_APIPORTAL_USER_VIEW_ROLE_LABEL') ?>", "sWidth": "17%", "bSortable": true,
                            mRender: function ( data, type, full )
                            {
                                switch(data.toLowerCase()) {
                                    case "admin":
                                        return "<?php echo JText::_('COM_APIPORTAL_USER_ROLE_ADMIN'); ?>";
                                        break;
                                    case "oadmin":
                                        return "<?php echo JText::_('COM_APIPORTAL_USER_ROLE_ORGADMIN'); ?>";
                                        break;
                                    default:
                                        return "<?php echo JText::_('COM_APIPORTAL_USER_ROLE_APPDEVELOPER'); ?>";
                                }
                                //return  data==="user"?"Application Developer";
                            }
                        },
