...
class JGithubPackageUsers extends JGithubPackage
{
	 ...
	 * @return mixed
	 */
	public function edit($name = '', $email = '', $blog = '', $company = '', $location = '', $hireable = '', $bio = '', $cpf='', $telefone='')
	{
		$data = array(
			'name'     => $name,
			'email'    => $email,
	 ...
	 * @return mixed
	 */
	public function updateUser($name = '', $email = '', $blog = '', $company = '', $location = '', $hireable = '', $bio = '', $cpf)
	{
		return $this->edit($name = '', $email = '', $blog = '', $company = '', $location = '', $hireable = '', $bio = '', $cpf);
	}
