...
if (!$error) {
    ...
    $data = array(
        ...
        'telefone' => $this->escape($user->telefone),
        'description' => $this->escape($user->description),
        'cpf' =>  $this->escape($user->cpf),
...
<?php if (!$showPendingLayout) { ?>
      <div class="form-group">
        <label style="font-size:14px" class="col-sm-2 control-label" for="phone">
          <?php echo JText::_('COM_APIPORTAL_USER_VIEW_DETAILS_PHONE_LABEL'); ?>:
        </label>
        <div style="font-size:14px" class="col-sm-4 form-control-static"><?php echo $this->escape($data['phone']); ?></div>
      </div><!-- .form-group -->

     <div class="form-group">
        <label style="font-size:14px" class="col-sm-2 control-label" for="telefone">
          <?php echo JText::_('COM_APIPORTAL_USER_VIEW_TELEFONE_LABEL'); ?>:
        </label>
        <div style="font-size:14px" class="col-sm-4 form-control-static"><?php echo $this->escape($data['telefone']); ?></div>
      </div>

               
      <div class="form-group">
        <label style="font-size:14px" class="col-sm-2 control-label" for="cpf">
          <?php echo JText::_('COM_APIPORTAL_USER_VIEW_CPF_LABEL'); ?>:
        </label>
        <div style="font-size:14px" class="col-sm-4 form-control-static"><?php echo $this->escape($data['cpf']); ?></div>
      </div><!-- .form-group -->
...
<?php if ($isProfileAction) { ?>
      <div class="form-group">
        ...
        <div style="font-size:14px" class="col-sm-4 form-control-static">
