...
<input type="hidden" class="form-control" id="autBase64" name="apidata[authBase64]"
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-4">
                    <div class="checkbox">
                        <label>
                            <input type="radio" name="apidata[enabled]"
                                   value='true' <?php echo($data['enabled'] == 'true' ? 'checked' : ''); ?>>
                            <?php echo JText::_('COM_APIPORTAL_APPLICATION_CREATE_GENERAL_ENABLE_LABEL'); ?>
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div class="form-actions">
            <button type='button' class='btn btn-primary' onclick="valida();" id='application-save-and-list-button'>
