<main>
  ...
  <div class="auto">
    ...
    <li onclick="location.href='api-catalog/'">
      <div role="region"><img src="/components/com_apiportal/assets/img/home/expolore.svg" alt="compass icon" class="svg" />
    ...
    <li onclick="location.href='apps'">
      <div role="region"><img src="/components/com_apiportal/assets/img/home/create.svg" alt="pencil icon" class="svg" />
    ...
    <li onclick="location.href='monitoring/'">
      <div role="region"><img src="/components/com_apiportal/assets/img/home/manage.svg" alt="gears icon" class="svg" />
  ...
  <div class="auto">
    ...
    <li role="presentation">
      <div role="region"><img src="/components/com_apiportal/assets/img/home/community.svg"
